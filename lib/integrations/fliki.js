...
(async () => {
    ...
    const generate = await api({
      ...
      params: {
        ...
        scenes: [
          ...
          {
            content:
              "Images of creative and technical professionals working on exciting projects",
            voiceId,
          },
          {
            content:
              "Images of people collaborating with experts in engineering, technology, and innovation",
            voiceId,
          },
        ],
        settings: {
  ...
  if (false) {
    ...
    const id = "64c29cd94b6169c12ecf0601";
